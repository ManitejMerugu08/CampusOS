    ...
    return (
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="page-header">
                <div>
                    <h1 className="page-title">Manage All Tickets</h1>
                    <p className="page-subtitle">{tickets.length} total tickets across all students.</p>
                </div>
            </div>
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                <CustomTable
                    columns={[
                        ...
                        { key: 'action', header: 'Update Status' }
                    ]}
                    data={filteredTickets.map(t => ({
                        ...
                        title: <span style={{ fontWeight: 700, color: 'var(--text-main)' }}>{t.title}</span>,
